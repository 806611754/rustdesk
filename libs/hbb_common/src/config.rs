...
pub const RENDEZVOUS_SERVERS: &[&str] = &["119.145.41.222","172.21.110.5","drivce.letcon.com.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "yLRm08drh+dj4b82YYadQaGaccBtD8e3q0QnDNrLpyY=";
